...
<body class="min-h-screen flex flex-col">
    ...
    <script>
        ...
        let votesLogs = JSON.parse(localStorage.getItem('votesLogs')) || [];
        ...
        document.getElementById('voteForm').onsubmit = (e) => {
            ...
            votesLogs.push(newVote);
            localStorage.setItem('votesLogs', JSON.stringify(votesLogs));
            alert("ድምጽዎ ተመዝግቧል!");
        ...
        function loadLogs() {
            document.getElementById('voterLogsTable').innerHTML = votesLogs.map(v => `
